...
import com.sunnyws.annotation.Dict;
import com.sunnyws.entity.Result;
import com.sunnyws.service.DictService;
import com.sunnyws.constant.CommonConstant;
import com.sunnyws.utils.CommnotUtil;
...
public class DictAspect {
     ...
     */
//    @Pointcut("execution( * com.sunnyws.dict.controller.*.*(..))")
    @Pointcut("@annotation(com.sunnyws.annotation.DictMethod)")
...
//            System.out.println(((Result) result).getResult() instanceof );
