package com.sunnyws.dict.aspect;
...
//    @Pointcut("execution( * com.sunnyws.dict.controller.*.*(..))")
    @Pointcut("@annotation(com.sunnyws.dict.annotation.DictMethod)")
